...
describe("jobs.create - Integration Tests", () => {
  ...
  describe("Authenticated User Job Creation", () => {
    ...
    it("should create a subscription for new users", async () => {
      // Arrange
      const caller = createTestCaller(testUserId);
  ...
  describe("Unauthenticated User Job Creation", () => {
    it("should create a job for an unauthenticated user", async () => {
      // Arrange
    ...
    it("should not create a subscription for unauthenticated users", async () => {
      // Arrange
      const caller = createTestCaller(null);
  ...
  describe("Job Queuing", () => {
    it("should queue jobs with correct initial status", async () => {
      // Arrange
      const caller = createTestCaller(testUserId);
    ...
    it("should create multiple jobs in sequence", async () => {
      // Arrange
      const caller = createTestCaller(testUserId);
  ...
  describe("Job Deduplication", () => {
    it("should return existing job for duplicate prompts", async () => {
      // Arrange
      const caller = createTestCaller(testUserId);
    ...
    it("should create separate jobs for different users with same prompt", async () => {
      // Arrange
  ...
  describe("Quota Enforcement", () => {
    it("should enforce quota limits for starter tier", async () => {
      // Arrange
      const caller = createTestCaller(testUserId);
    ...
    it("should allow job creation within quota limits", async () => {
      // Arrange
      const caller = createTestCaller(testUserId);
      ...
      // Act
      const result = await caller.jobs.create({ prompt: "Within quota test" });
  ...
  describe("Input Validation", () => {
    ...
    it("should accept prompts up to max length", async () => {
      // Arrange
      const caller = createTestCaller(testUserId);

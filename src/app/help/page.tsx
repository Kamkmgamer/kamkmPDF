    ...
    <main className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950/30">
      ...
      <section className="relative container mx-auto max-w-7xl px-6 py-32 text-center">
        ...
        >
          ...
          using{" "}
          <span className="bg-gradient-to-r from-blue-600 to-sky-600 bg-clip-text font-semibold text-transparent dark:from-blue-400 dark:to-sky-400">
            KamkmPDF
          </span>
          .
        </motion.p>
        ...
        <div className="space-y-4">
          {faqs.map((item, i) => (
            ...
            >
              ...
              <button
                onClick={() => toggleFAQ(i)}
                className="relative w-full rounded-3xl border border-slate-200 bg-white p-6 text-left transition-all duration-300 hover:border-blue-500/50 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-blue-400/50"
              >
                <div className="flex items-center justify-between">
                  <span className="pr-8 text-lg font-bold text-slate-900 dark:text-white">
                    {item.q}
                  </span>
                  <motion.div

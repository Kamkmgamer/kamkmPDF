      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-10">
          ...
          <p className="mt-3 text-lg text-gray-600 dark:text-gray-400">
            Choose a professional template to get started with your CV or
            resume.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {templates.map((template: Template) => (
            ...
            >
              {/* Card glow effect */}
              <div className="absolute -inset-0.5 rounded-3xl bg-gradient-to-r from-blue-600 to-indigo-600 opacity-0 blur-lg transition-all duration-500 group-hover/template:opacity-100"></div>

              <div className="relative h-full cursor-pointer rounded-3xl border border-gray-200/80 bg-white/80 shadow-xl shadow-gray-900/5 backdrop-blur-xl transition-all duration-300 group-hover/template:-translate-y-1 group-hover/template:shadow-2xl group-hover/template:shadow-gray-900/10 dark:border-gray-700/50 dark:bg-gray-900/80">
                ...
                <div className="p-5">
                  <h3 className="text-lg font-bold text-gray-900 transition-all duration-300 group-hover/template:bg-gradient-to-r group-hover/template:from-blue-600 group-hover/template:to-indigo-600 group-hover/template:bg-clip-text group-hover/template:text-transparent dark:text-white">
                    {template.name}
                  </h3>
